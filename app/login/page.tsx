      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-atlia-navy via-[#1a3570] to-[#2E75B6] flex-col justify-between p-12 text-white">
        ...
        <div>
          ...
          <p className="text-white/70 text-base leading-relaxed mb-10">
            Do planejamento à entrega — acompanhe cada projeto, indicador e
            objetivo estratégico do seu município em tempo real.
          </p>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-atlia-blue accent-atlia-blue"
                />
